...
export default class SocialEvents extends Vue {
    ...
    private async created() {
        ...
        this.upcomingEvents = await axios.get(`/events/byCategory/month`, {params: {category: "Social", date: new Date(oneMonthString)}}).then((result) => {
        ...
        this.eventsList = await axios.get(`/events/byCategory`, {params: {category: "Social"}}).then((result) => {
