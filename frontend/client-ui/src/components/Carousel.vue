    ...
    <div class="flex-horizontal">
        <div class="carousel-bg flex-horizontal">
            ...
            <div class="carousel flex-vertical centered" >
                ...
                <CarouselSlide v-for="(slide, index) in slides" :key="index" :index="index" :carouselRotation="carouselRotationIndex" :description="slide.description" :title="slide.title" :image="slide.image" :link="slide.link"/>
                </div>
                <div class="flex-horizontal dots">
                    <span :class="index === carouselRotationIndex ? 'filled-dot' : 'empty-dot'" v-for="(slide, index) in slides" :key="index"></span>
                </div>
            </div>
