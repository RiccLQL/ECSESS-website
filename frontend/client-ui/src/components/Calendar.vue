<template>
    <div class="calendar flex-vertical">
        <div v-for="(item, index) in calendar" :key="index" class="calendar-item flex-horizontal centered space-between">
            <div class="calendar-picture fourty">
                <Picture :alt="item.image.alt" :path="item.image.path" :size="calendarImageSize" />
            </div>
            <div class="calendar-item-content flex-horizontal centered space-between sixty">
                ...
                <div class="calendar-event-button twenty flex-vertical">
                    <Button :clickParams="item.link" @handleClick="goToLink" :color="buttonColor" :size="buttonSize" text="Go to event" />
                </div>
            </div>
        </div>
    </div>
